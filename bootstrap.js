...
(function (global, factory) {
  /** 三項演算子 condition ? expr1 : expr2 を使用している。しかも多重に */
  ...
  /*
   * 上の判定式は、
   * factory関数に渡す exports, jquery, Popperの形式を決めている
   */

  /*
   * 1. nodeJSを使っている場合 => require('')
   * 2. requireJSを使っている場合 => define('')
   * 3. そうでない場合 普通にglobalオブジェクトからjqueryとpopperを受けとる
   */
}(this, (function (exports,$,Popper) { 'use strict';

  /** jQuery本体とPopperの受け取り */
